...
const CHANNEL_STRUCTURE = [
  ...
  },
  {
    ...
    channels: [
      ...
      { name: '𓊈📋𓊉 • chain_of_command', type: ChannelType.GuildText },
  ...
  },
  {
    ...
    channels: [
      ...
      { name: '𓊈🎖️𓊉 • rank_req', type: ChannelType.GuildText },
      { name: '𓊈🐞𓊉 • bug_reports', type: ChannelType.GuildText },
  ...
  },
  {
    name: '🎫 || SUPPORT',
    channels: [
      { name: '𓊈🎫𓊉 • open_ticket', type: ChannelType.GuildText },
  ...
  },
  {
    ...
    channels: [
      { name: '𓊈🎯𓊉 • tryouts_1', type: ChannelType.GuildVoice },
      { name: '𓊈🎯𓊉 • tryouts_2', type: ChannelType.GuildVoice },
      { name: '𓊈🪖𓊉 • training_1', type: ChannelType.GuildVoice },
      { name: '𓊈🪖𓊉 • training_2', type: ChannelType.GuildVoice },
  ...
  },
  {
    ...
    channels: [
      ...
      { name: '𓊈👑𓊉 • co_owner', type: ChannelType.GuildText },
...
client.once('ready', async () => {
  try {
    ...
    for (const categoryData of CHANNEL_STRUCTURE) {
      try {
        const category = await guild.channels.create({
          ...
          reason: '[GVBA] Fixed Channel Structure v2'
        });
    ...
    console.log('\n✅ All channels fixed with CORRECT format!');
  } catch (error) {
